...
$('.meetings.meet_now').ready(function(){
    togglePassword();
    document.getElementById('meeting_privacy').onclick = function() {
        togglePassword()
    }
...
function togglePassword(){
    if (document.getElementById("meeting_privacy").checked) {
        document.getElementById('meeting_password_group').style.display = 'inline';
    } else {
        document.getElementById('meeting_password_group').style.display = 'none';
    }
